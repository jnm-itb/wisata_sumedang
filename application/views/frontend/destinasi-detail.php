...
<div class="card-product-body-lg">
	<strong  style="font-size : 22px!Important;"  class="card-product-title"><?php echo($data->judul) ;  ?></strong> 
</div>
...
<div class="">
<a class="btn btn-success w-100 pt-2 pb-2" target="_blank" href="https://wa.me/<?php echo($whatsapp) ;  ?>/?text=Halo Biro Jasa <?php echo($data->judul) ;  ?>" >  Hubungi Biro perjalanan </a> 
