...
<div class="p-3">
<h5  style="font-weight : bold;margin:0px !important; " > Home Stay / Tempat Tinggal </h5>
<p  style="font-weight : 500; font-size : 14px; margin:0px !important; " > Lihat Home Stay / Tempat Tinggal Yang berada disekitar sumedang </p> 
...
<div class="padding bg-light pt-2 pb-2">
	...
	<div class="card-flex align-items-center justify-content-center">
		...
		<div class="ps-3">
			...
			<p class="m-0"> <b> Tidak Ditemukan </b> <br /> <small class="fs-12"> Hotel/ Perumahan yang anda cari tidak ditemukan </small> </p> 
		</div>
		</div>
	</div>  
