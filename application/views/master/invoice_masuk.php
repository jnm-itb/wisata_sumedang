...
if(isset($_POST['konfirmasi'])){
	$id = in($_POST['id']);
	$this->db->query("UPDATE invoice SET `status`='Pengiriman Selesai' WHERE id='$id'  ");
	$alert = "success";
	$respon = "Berhasil Menandai Invoice Menjadi <b> Pengiriman Selesai </b>";
} 
...
<div class="card-header bg-primary">
	<h5 class="m-0  text-light"> Invoice Perlu Dikirim  </h5>  
</div>
<div class="card-body shadow-sm">
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			$sql = "`status`= 'Sedang Di Proses' ORDER BY id DESC LIMIT 20  ";
						...
						<td> 
							<div class="dropdown dropdown-right">
							  ...
							  <div  style="right:0px!Important; left:auto"  class="dropdown-menu" id="d" aria-labelledby="dropdownMenuButton"> 
								<a class="dropdown-item" onclick="showconf('<?php echo($data->id) ;  ?>','Telah Dikirim <?php 	echo($data->invoice) ;  ?>')">Telah Dikirim</a>
