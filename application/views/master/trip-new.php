...
$text = in($_POST['text']);
	...
	$row = $this->model->row("trip","judul='$judul' and whatsapp='$whatsapp'  ");
	if($row >= 1){
		$alert = "danger";
...
<a class="btn btn-primary mb-2" href="<?php echo($site) ?>master/trip" > Kembali </a> 
...
<div class="card-body shadow-sm">
	<form method="post" enctype="multipart/form-data"> 
		...
		<input type="text" required class="form-control" name="judul" value="" placeholder="Judul Trip"    />
		<br />
		<span> Image </span> 
